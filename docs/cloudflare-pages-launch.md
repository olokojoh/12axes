...
The build validates the exact authorized AdSense seller line before compiling. It then bundles the vinext Worker as `dist/client/_worker.js` for Pages Advanced Mode. No secret, D1, R2, KV, Queue, or service binding is required.
